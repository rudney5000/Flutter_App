...
import 'package:flutter_app1/utils/app_styles.dart';
import 'package:flutter_app1/widgets/thick_container.dart';
...
class TicketView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      height: AppLayout.getHeight(GetPlatform.isAndroid==true? 177:180),
      child: Container(
